    ...
    <div>
      <div className="container mx-auto lg:px-72 md:px-16 sm:px-8 sm:mt-8 lg:mt-16 text-left font-serif">
        ...
        <div className="flex align-middle opacity-65 mt-5">
          {/* mail */}
          <a href="mailto:chriskfwoo@gmail.com?subject=Hello!" target="_blank" className="mr-1">
          ...
          {/* linkedin */}
          <a href="https://www.linkedin.com/in/chriskfwoo/" target="_blank" className="mr-1">
          ...
          {/* github */}
          <a href="https://github.com/chriskfwoo" target="_blank" className="mr-1">
          ...
          {/* instagram */}
          <a href="https://www.instagram.com/chriswoozzie/" target="_blank" className="mr-1">
          ...
          {/* strava */}
          <a href="https://www.strava.com/athletes/11843531" target="_blank" className="mr-1">
